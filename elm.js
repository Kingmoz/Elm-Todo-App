...
var author$project$Main$init = function (model) {
	return _Utils_Tuple2(
		A2(
			...
			A2(author$project$Main$Model, _List_Nil, 0),
			model),
...
var author$project$Main$blurInput = function (id) {
	return A2(
		...
		elm$browser$Browser$Dom$blur(
			'item-' + elm$core$String$fromInt(id)));
};
...
var author$project$Main$newItem = function (id) {
	return {completed: false, content: '', id: id};
};
	...
	function (msg, model) {
		switch (msg.$) {
					...
					_Utils_update(
						model,
						{
							items: _Utils_ap(
								...
								_List_fromArray(
									[
										author$project$Main$newItem(model.uid)
									])),
							uid: model.uid + 1
						}),
					author$project$Main$focusInput(model.uid));
			case 'Modify':
				var id = msg.a;
				var content = msg.b;
				var updateEntry = function (item) {
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							items: A2(elm$core$List$map, updateEntry, model.items)
						}),
					elm$core$Platform$Cmd$none);
			case 'Delete':
				var id = msg.a;
			...
			default:
				...
				return _Utils_Tuple2(
					model,
					author$project$Main$blurInput(id));
		}
	});
...
var author$project$Main$Modify = F2(
	function (a, b) {
...
var author$project$Main$Complete = F2(
	function (a, b) {
		return {$: 'Complete', a: a, b: b};
	});
...
var author$project$Main$viewCompleteCheckBox = function (todo) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('mdc-checkbox list__item__complete')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						A2(author$project$Main$Complete, todo.id, !todo.completed))
					]),
				_List_Nil),
				A2(
				elm$html$Html$div,
...
var author$project$Main$viewDeleteButton = function (id) {
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('mdc-icon-button material-icons list__item__delete-btn'),
				elm$html$Html$Events$onClick(
				author$project$Main$Delete(id))
			]),
		_List_fromArray(
			[
...
var author$project$Main$viewTodoItem = function (todo) {
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('mdc-list-item list__item')
			]),
		_List_fromArray(
			[
				author$project$Main$viewCompleteCheckBox(todo),
				A2(
				elm$html$Html$div,
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('mdc-list-item__text list__item__input')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								'item-' + elm$core$String$fromInt(todo.id)),
								elm$html$Html$Attributes$class('list__item__input__text-area'),
								...
								author$project$Main$Modify(todo.id)),
								author$project$Main$onEnter(
								author$project$Main$Blur(todo.id))
							]),
						_List_Nil)
					])),
				author$project$Main$viewDeleteButton(todo.id)
			]));
};
var elm$html$Html$ul = _VirtualDom_node('ul');
var author$project$Main$viewTodoItems = function (todoitems) {
	return A2(
		elm$html$Html$ul,
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('mdc-list list')
			]),
		A2(elm$core$List$map, author$project$Main$viewTodoItem, todoitems));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('mdc-card card')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('card__header__inner')
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												elm$html$Html$Attributes$class('card__header__title')
											]),
										_List_fromArray(
											[
										...
										_List_fromArray(
											[
												elm$html$Html$Attributes$class('mdc-icon-button material-icons'),
						...
						author$project$Main$viewTodoItems(model.items)
					]))
			]));
};
											...
											return A2(
												...
												function (content) {
													return A2(
														...
														function (completed) {
															return elm$json$Json$Decode$succeed(
																{completed: completed, content: content, id: id});
														},
